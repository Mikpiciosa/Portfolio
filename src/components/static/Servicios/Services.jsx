    ...
    <div className="services__container">
      ...
      <section className="service__diseñouxui ">
        ...
        <p>
          ...
          UX con una amplia investigacion sobre el rubro en el cual esta
          apuntando y con el UI para generar una web/app atractiva e intuitiva a
          la vista de cualquier usuario.
        </p>
      ...
      <section className="service__diseñouxui">
        <h2 className="titulo">aca iria otro xd</h2>
        <p>
          Con nuestro servicio de diseño UX/UI ofrecemos acompañamiento desde el
          UX con una amplia investigacion sobre el rubro en el cual esta
          apuntando y con el UI para generar una web/app atractiva e intuitiva a
